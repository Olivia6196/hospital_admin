...
const StatCard = () => {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      {stats.map((card) => (
        <div key={card.label} className="flex gap-4 bg-white/95 dark:bg-black/30 border backdrop-blur-2xl border-white/20 shadow hover:shadow-2xl z-10 rounded-2xl px-5 py-3 hover:translate-y-1">
