    ...
    const fetchDoctors = async () => {
      ...
      try {
        const response = await fetch(
          `/api/doctors?service=${encodeURIComponent(form.service)}`,
        );
            ...
            {[
              ...
              <div key={n} className="flex items-center gap-3">
                <div className="flex flex-col items-center">
                  ...
                  <span
                    className={`text-xs mt-1.5 font-medium ${step === n ? "text-blue-600 dark:text-blue-400" : "text-gray-400 dark:text-gray-500"}`}
                  >
                    {label}
                  </span>
                </div>
                {i < arr.length - 1 && (
                  <div
                    className={`h-0.5 w-12 md:w-20 -mt-3.5 ${step > n ? "bg-blue-600" : "bg-gray-200 dark:bg-gray-700"}`}
                  />
                )}
              </div>
            ))}
                ...
                <div className="p-5 md:p-8">
                  ...
                  {form.service ? (
                    loadingDoctors ? (
                      ...
                      <div className="text-center py-12 text-gray-500">
                        No doctors available for the selected service at the
                        moment.
                      </div>
                    )
                  ) : (
                ...
                <div className="p-8">
                  ...
                  <div className="mt-8 flex justify-between">
                    <button
                      type="button"
                      onClick={() => setStep(1)}
                      className="px-6 py-3 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
                    >
                      Back
                    </button>
                    <button
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        type: "number",
                        placeholder: "25",
                      }, // Note: age not in form state - add if needed
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        { icon: User, label: "Service", value: form.service },
                        {
                          icon: User,
                          label: "Doctor",
                          value: form.doctor || "Not selected",
                        },
