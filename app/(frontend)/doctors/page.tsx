...
const doctors = [
  { name: 'Dr. Sarah Johnson', specialty: 'Cardiology', rating: 4.9, experience: '12 Years', patients: 2400, image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&h=500&fit=crop&crop=face', education: 'Harvard Medical School', bio: 'Specializing in interventional cardiology with expertise in complex coronary interventions and structural heart disease.' },
  { name: 'Dr. Michael Chen', specialty: 'Neurology', rating: 4.8, experience: '7 Years', patients: 1900, image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=500&fit=crop&crop=face', education: 'Johns Hopkins University', bio: 'Expert in movement disorders and neurodegenerative diseases with a focus on Parkinson\'s disease management.' },
  { name: 'Dr. Amelia Roberts', specialty: 'Pediatrics', rating: 5.0, experience: '8 Years', patients: 1200, image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=400&h=500&fit=crop&crop=face', education: 'Stanford Medical School', bio: 'Dedicated to providing comprehensive pediatric care from newborns through adolescence with a warm, family-centered approach.' },
  { name: 'Dr. James Wilson', specialty: 'Orthopedics', rating: 4.7, experience: '5 Years', patients: 1000, image: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=400&h=500&fit=crop&crop=face', education: 'Mayo Clinic', bio: 'Specializing in total joint replacement and sports medicine injuries with minimally invasive surgical techniques.' },
  ...
  { name: 'Dr. David Park', specialty: 'Cardiology', rating: 4.6, experience: '6 Years', patients: 400, image: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=400&h=500&fit=crop&crop=face', education: 'University of Pennsylvania', bio: 'Focusing on preventive cardiology, echocardiography, and heart failure management in complex cardiac patients.' },
  { name: 'Dr. Dan Watson', specialty: 'Neurology', rating: 4.7, experience: '5 Years', patients: 350, image: '/images/doctor9.jfif', education: 'Duke University', bio: 'Specializing in epilepsy management and neuro-oncology, with extensive experience in EEG diagnostics and seizure treatment plans.' },
  ...
  { name: 'Dr. Nathan Brooks', specialty: 'Orthopedics', rating: 4.6, experience: '5 Years', patients: 450, image: '/images/doctor13.jfif', education: 'Mayo Clinic', bio: 'Spine and disc specialist focused on non-surgical rehabilitation and advanced spinal fusion techniques for chronic pain.' },
  ...
  { name: 'Dr. Thomas Adler', specialty: 'Neurology', rating: 4.5, experience: '4 Years', patients: 100, image: '/images/doctor16.jfif', education: 'University of Michigan', bio: 'Focused on headache medicine and migraine intervention, with subspecialty training in neuroimaging and pain management.' },
  ...
  { name: 'Dr. Fatima Hassan', specialty: 'Oncology', rating: 4.9, experience: '3 Years', patients: 150, image: '/images/doctor35.jfif', education: 'Oxford University', bio: 'Gastrointestinal oncologist with expertise in colorectal, pancreatic, and hepatocellular carcinoma, including palliative care.' },
  ...
  { name: 'Dr. Owen Clarke', specialty: 'Surgery', rating: 4.6, experience: '5 Years', patients: 120, image: '/images/doctor20.jfif', education: 'University of Toronto', bio: 'Hepatobiliary surgeon specializing in liver transplantation, biliary reconstruction, and pancreatic surgery.' },
  ...
  { name: 'Dr. Sophie Martin', specialty: 'Neurology', rating: 4.7, experience: '4 Years', patients: 150, image: '/images/doctor27.jfif', education: 'McGill University', bio: 'Neurologist specializing in multiple sclerosis and demyelinating diseases, with expertise in disease-modifying therapies.' },
  ...
  { name: 'Dr. Rachel Stone', specialty: 'Ophthalmology', rating: 4.9, experience: '5 Years', patients: 700, image: '/images/doctor28.jfif', education: 'University of Oxford', bio: 'Pediatric ophthalmologist treating amblyopia, strabismus, and congenital eye disorders in infants and young children.' },
  ...
  { name: 'Dr. Ingrid Halvorsen', specialty: 'Orthopedics', rating: 4.9, experience: '4 Years', patients: 30, image: '/images/doctor34.jfif', education: 'University of Oslo / HSS New York', bio: 'Pediatric orthopedic surgeon specializing in scoliosis correction, club foot treatment, and limb length discrepancy.' },
  ...
  { name: 'Dr. Bernard Osei', specialty: 'Ophthalmology', rating: 4.7, experience: '11 Years', patients: 2200, image: '/images/doctor39.jfif', education: 'University of Ghana / Moorfields Eye Hospital', bio: 'Glaucoma specialist providing medical and surgical interventions including trabeculectomy and tube shunt implantation.' },
...
export default function DoctorsPage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      ...
      <section className="py-8 px-4 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-10 shadow-sm">
