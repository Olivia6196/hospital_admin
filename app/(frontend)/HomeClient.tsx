...
const services = [
  {
    icon: Heart,
    title: "Cardiology",
    desc: "Advanced heart care with state-of-the-art diagnostic equipment and experienced specialists.",
    color: "red",
  },
  {
    icon: Brain,
  ...
  },
  {
    icon: Bone,
    title: "Orthopedics",
    desc: "Comprehensive bone, joint, and muscle care including joint replacement surgery.",
    color: "blue",
  },
  {
    icon: Baby,
    title: "Pediatrics",
    desc: "Specialized care for infants, children, and adolescents with compassion and expertise.",
    color: "green",
  },
  {
    icon: Microscope,
    title: "Diagnostics",
    desc: "Advanced lab tests and imaging for accurate diagnosis and treatment planning.",
    color: "cyan",
  },
  {
    icon: Zap,
    title: "Emergency Care",
    desc: "24/7 emergency services with rapid response teams and critical care specialists.",
    color: "orange",
  },
];
...
const blogs = [
  {
    ...
    excerpt:
      "Heart disease remains the leading cause of death worldwide. Learn how to reduce your risk with lifestyle changes and early screening.",
    category: "Cardiology",
    date: "Dec 10, 2024",
...
const testimonials = [
  {
    ...
    role: "Patient",
    rating: 5,
    avatar: "/images/review_one.jpg",
    text: "MediCore truly cares about its patients. The doctors and staff went above and beyond to make me feel comfortable during my treatment.",
  },
  {
    name: "Robert Martinez",
    role: "Patient",
    rating: 5,
    avatar: "/images/review_two.jpg",
    text: "Exceptional care from the moment I walked in. The team was professional, attentive, and made my recovery much smoother than expected.",
  },
  {
    name: "Linda Thompson",
    role: "Patient",
    rating: 5,
    avatar: "/images/review_three.jpg",
    text: "I couldn't be happier with the treatment I received. The doctors were knowledgeable and explained everything clearly.",
  },
];
  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div
          className="absolute top-0 right-0 w-1/2 h-full opacity-5 dark:opacity-10"
          style={{
            background:
              "radial-gradient(circle at 70% 50%, #2563eb 0%, transparent 90%)",
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up">
            <h1 className="font-display text-5xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6">
              Find a Doctor
              <br />
              <span className="text-blue-600">and Book Online</span>
            </h1>
            <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-8 max-w-lg">
              ...
              Connect with 35+ specialists, book appointments, and manage your
            ...
            <div className="flex flex-wrap gap-6 pt-6 border-t border-gray-100 dark:border-gray-800">
              {[
                ...
                <div key={label} className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="font-display font-bold text-gray-900 dark:text-white text-lg leading-tight">
                      {val}
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            <SectionHeader
              ...
              subtitle="From routine check-ups to complex surgeries, we offer a full range of medical services."
            />
            <Link
              href="/services"
              className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:gap-3 transition-all whitespace-nowrap"
            >
      ...
      <section ref={ref} className="py-7 bg-blue-600 dark:bg-blue-700 px-4">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <SectionHeader
              ...
              subtitle="We combine cutting-edge technology with compassionate care to deliver the best possible outcomes for every patient."
            />
              ...
              {[
                {
                  ...
                  desc: "All our doctors are board-certified with extensive training in their respective fields.",
                },
                {
                  icon: Zap,
                  title: "Advanced Technology",
                  desc: "We use the latest medical technology and evidence-based treatments for optimal outcomes.",
                },
                {
                  icon: Heart,
                  title: "Patient-Centered Care",
                  desc: "Your comfort and recovery are our top priorities throughout your care journey.",
                },
                {
                  icon: Clock,
                  title: "24/7 Support",
                  desc: "Round-the-clock emergency care and patient support whenever you need it.",
                },
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg mb-8">
            Schedule your visit with our specialists. Choose your preferred
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            <SectionHeader
              ...
              subtitle="Stay informed with the latest in healthcare and wellness."
            />
            <Link
              href="/blog"
              className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:gap-3 transition-all whitespace-nowrap"
